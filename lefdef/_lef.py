...
class C_Lef_Pin(ctypes.Structure):
    ...
    def print(self, start : int = 0):
        ...
        print(f"\033[92m{' ' * (start - 3)}---| \033[93mshape: \033[94m", self.c_shape)
        print(f"\033[92m{' ' * (start - 3)}---| \033[93mnum ports: \033[94m", self.c_num_ports)
...
class C_Lef_Macro(ctypes.Structure): 
    ...
    def print(self, start : int = 0):
        ...
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mname: \033[94m", self.c_name)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mclass: \033[94m", self.c_class)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93msource: \033[94m", self.c_source)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93msite name: \033[94m", self.c_site_name)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93morigin x: \033[94m", self.c_origin_x)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93morigin y: \033[94m", self.c_origin_y)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93msize x: \033[94m", self.c_size_y)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93msize y: \033[94m", self.c_size_y)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mforeign name: \033[94m", self.c_foreign_name)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mforeign x: \033[94m", self.c_foreign_x)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mforeign y: \033[94m", self.c_foreign_y)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mforeign orient: \033[94m", self.c_foreign_orient)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mnum pins: \033[94m", self.c_num_pins)
