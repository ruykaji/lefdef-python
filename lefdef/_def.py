...
class C_Def_Port(ctypes.Structure):
    ...
    def print(self, start : int = 0):
        ...
        print(f"\033[92m{' ' *start}---| \033[93mnum rects: \033[94m", self.c_num_rects)
...
class C_Def_Row(ctypes.Structure):
    ...
    def print(self, start : int = 0):
        ...
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mrow: \033[94m", self.c_name)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mmacro: \033[94m", self.c_macro)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mx: \033[94m", self.c_x)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93my: \033[94m", self.c_y)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mnum_x: \033[94m", self.c_num_x)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mnum_y: \033[94m", self.c_num_y)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mstep_x: \033[94m", self.c_step_x)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mstep_y: \033[94m", self.c_step_y)
...
class C_Def_Track(ctypes.Structure):
    ...
    def print(self, start : int = 0):
        ...
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mlayer: \033[94m", self.c_layer)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93moffset: \033[94m", self.c_offset)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mnum: \033[94m", self.c_num)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mstep: \033[94m", self.c_step)
...
class C_Def_Component(ctypes.Structure):
    ...
    def print(self, start : int = 0):
        ...
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mid: \033[94m", self.c_id)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mnum: \033[94m", self.c_name)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mstatus: \033[94m", self.c_status)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93msource: \033[94m", self.c_source)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93morient: \033[94m", self.c_orient)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93mx: \033[94m", self.c_x)
        print(f"\033[92m{' ' *(start - 3)}---| \033[93my: \033[94m", self.c_y)
...
class C_Def_Pin(ctypes.Structure):
    ...
    def print(self, start : int = 0):
        ...
        print(f"\033[92m{' ' * (start - 3)}---| \033[93mname: \033[94m", self.c_name)
        print(f"\033[92m{' ' * (start - 3)}---| \033[93mnet: \033[94m", self.c_net)
        print(f"\033[92m{' ' * (start - 3)}---| \033[93muse: \033[94m", self.c_use)
        print(f"\033[92m{' ' * (start - 3)}---| \033[93mstatus: \033[94m", self.c_status)
        print(f"\033[92m{' ' * (start - 3)}---| \033[93mdirection: \033[94m", self.c_direction)
        print(f"\033[92m{' ' * (start - 3)}---| \033[93morient: \033[94m", self.c_orient)
        print(f"\033[92m{' ' * (start - 3)}---| \033[93mx: \033[94m", self.c_x)
        print(f"\033[92m{' ' * (start - 3)}---| \033[93my: \033[94m", self.c_y)
...
class C_Def_Net(ctypes.Structure):
    ...
    def print(self, start : int = 0):
        ...
        print(f"\033[92m{' ' *start}---| \033[93mnum pins: \033[94m", self.c_num_pins)
...
class C_Def(ctypes.Structure):
    ...
    def print(self):
        ...
        print("\033[92m---| \033[93m:points: \033[94m",[f"({self.c_die_area_width[i]}, {self.c_die_area_height[i]})" for i in range(self.c_num_points)])
        print("\033[92m---| \033[93m:num g cell_grid x \033[94m", self.c_num_g_cell_grid_x)
        print("\033[92m---| \033[93m:num g cell grid y \033[94m", self.c_num_g_cell_grid_y)
        print("\033[92m---| \033[93m:num components \033[94m", self.c_num_components)
        ...
        print("\033[92m---| \033[93m:num tracks x \033[94m", self.c_num_tracks_x)
        print("\033[92m---| \033[93m:num tracks y \033[94m", self.c_num_tracks_y)
